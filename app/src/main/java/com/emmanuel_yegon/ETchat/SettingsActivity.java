...
import com.emmanuel_yegon.ETchat.databinding.ActivitySettingsBinding;
        ...
        binding.saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!binding.etStatus.getText().toString().equals("") && !binding.txtUsername.getText().toString().equals("")) {
                    ...
                    Toast.makeText(SettingsActivity.this,"Please fill username and status",Toast.LENGTH_SHORT).show();
                }
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Log.e("DownloadUrl", "Failed to obtain download URL: " + e.getMessage());
                        }
                    });
                }
            });
